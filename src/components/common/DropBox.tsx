...
const DropBox = ({ topEvent, bottomEvent }: DropBoxProps) => {
  ...
  return (
    <div className="relative flex h-10 w-10 items-center justify-center rounded-md hover:bg-[rgba(52,58,64,0.1)] hover:transition-colors">
      ...
      />
      {isOpen && (
        <ul className="absolute z-50 right-2 top-12 flex h-fit w-[85px] cursor-pointer list-none flex-col items-center gap-y-2 rounded-md border-[1px] border-[rgba(0,0,0,0.15)] bg-white py-2">
